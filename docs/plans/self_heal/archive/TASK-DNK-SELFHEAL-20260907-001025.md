<!--
# --- DNK-MRH-HEADER ---
# mrh_id: "docs/plans/self_heal/TASK-DNK-SELFHEAL-20260907-001025.md"
...
- **Task ID**: `TASK-DNK-SELFHEAL-20260907-001025`
...
### ⚠️ 56. MASE Tool Budget Breached (1864 > 25 calls) (`BUDGET_BREACH` - HIGH)
- **Опис**: Task executed with 1864 tool calls, exceeding the atomic slice limit of 25 calls.
- **Лог / Стек**: ```text
Total tool calls: 1864
```

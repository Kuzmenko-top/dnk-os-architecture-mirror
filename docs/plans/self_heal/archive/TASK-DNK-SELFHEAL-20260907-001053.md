<!--
# --- DNK-MRH-HEADER ---
# mrh_id: "docs/plans/self_heal/TASK-DNK-SELFHEAL-20260907-001053.md"
# purpose: "Автономна задача самолікування системи (Self-Healing) після сесії 20260906_130531_905b51."
...
# 🏥 САМОЛІКУВАННЯ СИСТЕМИ: MASE Tool Budget Breached (28 > 25 calls)

> **Автономна детекція від Session Sentinel (`gerych_auditor`)**
> Під час виконання сесії `20260906_130531_905b51` виявлено 1 критичних або алгоритмічних дефектів.
...
- **Task ID**: `TASK-DNK-SELFHEAL-20260907-001053`
- **Title**: `[Self-Heal] MASE Tool Budget Breached (28 > 25 calls)`
...
- **Origin Session ID**: `20260906_130531_905b51`
- **Recursion Depth**: `1`
...
### ⚠️ 1. MASE Tool Budget Breached (28 > 25 calls) (`BUDGET_BREACH` - HIGH)
- **Опис**: Task executed with 28 tool calls, exceeding the atomic slice limit of 25 calls.
- **Лог / Стек**: ```text
Total tool calls: 28
```

...
def apply_delta_sync(
    ...
    # 1. Mutate Nodes
    node_map = {n["id"]: n for n in current_scene.get("nodes", []) if isinstance(n, dict) and "id" in n}
    ...
    # 2. Mutate Edges
    edge_map = {e["id"]: e for e in current_scene.get("edges", []) if isinstance(e, dict) and "id" in e}
